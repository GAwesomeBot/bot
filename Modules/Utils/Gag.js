/* Gag; gar without all the gagging that comes with trying to implement it in GAB
* An edited version of ethanent/gar
* This code may be (partially) licensed under the LICENSE file present in the ethanent/gar GitHub repo
*/
